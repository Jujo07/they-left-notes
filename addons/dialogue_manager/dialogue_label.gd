...
func _ready() -> void:
	# Instala el efecto glitch al inicio
	install_effect(GlitchEffect.new())
	print("GlitchEffect instalado en DialogueLabel!")

	install_effect(GlitchEffect.new())
	print("=== GLITCH INSTALADO EN ESTE DIALOGUE LABEL ===")
	print("BBCode Enabled:", bbcode_enabled)  # Debe ser true
